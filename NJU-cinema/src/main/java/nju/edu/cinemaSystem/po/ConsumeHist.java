...
public class ConsumeHist {
    ...
    public ConsumeHist(int id,float consume,float balance_befo, float balance_after,Timestamp date,int vip_card_id){
        this.id=id;
    ...
    public ConsumeHist(float consume,float balance_befo, float balance_after,Timestamp date,int vip_card_id){
        this.consume=consume;
        this.balance_befo=balance_befo;
        this.balance_after=balance_after;
        this.date=date;
