...
import nju.edu.cinemaSystem.bl.statistics.MovieLikeService;
import nju.edu.cinemaSystem.blImpl.management.schedule.MovieServiceForBl;
import nju.edu.cinemaSystem.vo.MovieBatchOffForm;
import nju.edu.cinemaSystem.vo.MovieForm;
import nju.edu.cinemaSystem.bl.management.MovieService;
...
public class MovieController {
    ...
    public ResponseVO getMovieById(@PathVariable int id){
        try {
            return ResponseVO.buildSuccess(movieServiceForBl.getMovieById(id));
        } catch (Exception e) {
            e.printStackTrace();
